...
Samples are taken from Gamma(3, 0.5) distribution and $k = 500$ in all the cases. Small values of n considered in the range  ${2, 3, \ldots, 10}$ and large values of $n$ considered within ${25, 30, 35, \ldots, 45}$. We study the distribution of:
...
Q: So when we are talking about normalising for the levels when number of levels are low? - Not by using limit theorems. Transformation?
...
create_simdata <- function(nx = 2,
                           ...
                           sim_dist = distributional::dist_gamma(shape = shape1, 
                                                                 rate = rate1),
