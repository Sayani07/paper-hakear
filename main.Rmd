...
Simulation experiments with different designs could help monitor and understand the behavior of the test statistic.


### Impact of different levels from the same distribution of the measured variable (for understanding size)

A 2 way contingency table with number of facet levels, x-axis levels should be constructed with values as the p-values.

Table
Conclusions
(in Null distribution)

### Impact of different distribution of the measured variable keeping the same distribution for each
panel (for understanding size)
...
### Impact of simulating different distributions across categories for understanding power
