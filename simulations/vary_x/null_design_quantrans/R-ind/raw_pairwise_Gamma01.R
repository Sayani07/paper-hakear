...
sim_varf = function(nx, 
                    ...
                    w)
{
  rep(dist_gamma((shape + seq(0, nfacet-1, by  = 1)*w), rate), each = nx)
}
...
if(!dir.exists("simulations/vary_facet/raw/data-ind/wpd_Gamma01"))
{
  dir.create("simulations/vary_facet/raw/data-ind/wpd_Gamma01")
}
saveRDS(raw_dist,
