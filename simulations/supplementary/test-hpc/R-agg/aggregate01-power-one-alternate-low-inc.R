...
folder = "data-ind-power-one-alternate-low-inc/"
  
all_files = list.files(path = paste0("simulations/supplementary/test-hpc/", folder), 
                       pattern = ".csv")
...
all_files_path <- paste0("simulations/supplementary/test-hpc/", folder, 
         all_files)  
