...
harmony_table <- expand.grid(
  ...
  mutate(design = c("null", "null", "varall", "null", "null", "null", "varall", "null", "null"))

# parameters and design used for this simulation
npermj <- 2
ntimesj <- 500
nsampj <- 10
wj <- 5 # change this to change increment
...
write_csv(
  ...
  paste0("../data-ind-power-two-alternate-high-inc/", "seed-id-", scen, ".csv")
)
...
# write_csv(
#   null_harmony_oneseed,
#   paste0("simulations/supplementary/test-hpc/data-ind-power-one-alternate-med-inc/", "seed-id-", scen, ".csv")
# )
# 
