...
if(designj=="null")
{
  sim_function <-  function(nxj, nfacetj){
...
if(!dir.exists("simulations/supplementary/raw/data-ind/wpd_N01"))
{
  dir.create("simulations/supplementary/raw/data-ind/wpd_N01")
}


if(!dir.exists("simulations/supplementary/norm/data-ind/wpd_N01"))
{
  dir.create("simulations/supplementary/norm/data-ind/wpd_N01")
}

saveRDS(dist_data,
        paste0('../typej/data-ind/wpd_N01/',
               "design:", designj, "_",
               "nxj:", nxj,'_',
               "nfacetj:", nfacetj,"_",
               "w:", wj,"_",
               "nperm:", npermj,"_",
               "ntimes:", ntimesj,"_",
               '_wpd.rds')) # seed and dist not included yet
