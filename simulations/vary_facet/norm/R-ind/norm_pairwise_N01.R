...
# simtable<-read_csv(here::here('simulations/vary_facet/null_design_quantrans/sim_table.csv'))
...
if(!dir.exists("simulations/vary_facet/null_design_quantrans/data-ind/wpd_N01"))
{
  dir.create("simulations/vary_facet/null_design_quantrans/data-ind/wpd_N01")
}
saveRDS(raw_dist,
