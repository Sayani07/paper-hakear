...
sim_varf_normal_varymean = function(nx, nfacet, mean, sd, w)
{
...
sim_varx_normal_varymean = function(nx, nfacet, mean, sd, w)
{
...
sim_varall_normal_varymean = function(nx, nfacet, mean, sd, w)
{
