...
if(!dir.exists("simulations/vary_x/null_design_quantrans/data-ind/wpd_N55"))
{
  dir.create("simulations/vary_x/null_design_quantrans/data-ind/wpd_N55")
}
saveRDS(raw_dist,
        paste0('../data-ind/wpd_N55/',
               nxj,'_',
               nfacetj,"_",
               wj, '_wpd.rds'))
