...
sim_varx_normal = function(nx, 
                           ...
                           w)
{
  rep(dist_normal((shape + seq(0, nx-1, by  = 1)*w), rate), nfacet)
}
...
if(!dir.exists("simulations/vary_x/null_design_quantrans/data-ind/wpd_Gamma01"))
{
  dir.create("simulations/vary_x/null_design_quantrans/data-ind/wpd_Gamma01")
}
saveRDS(raw_dist,
