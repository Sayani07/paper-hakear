...
```{r calendar- <- , fig.height = 10.5, fig.cap="Calendar display."}
...
_Validating ranks of one household_

_Comparing households_

_Validating patterns from linear display_ 


This is expected to have an assymmetrical distribution as could be seen in \ref{fig:raw-nqt} and the Normal score transform has been applied to make it more symmetric. Let $v*_{i, t}$ denote the normal-quantile transformed electricity demand for $i^{th}$ household for time period $t$.
