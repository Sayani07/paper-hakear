...
gridExtra::grid.arrange(gridExtra::arrangeGrob(p1, top = paste("MMPD_norm:", round(r1, 3))),
                        gridExtra::arrangeGrob(p2, top = paste("MMPD_norm:", round(r2, 3))),
                        gridExtra::arrangeGrob(p3, top = paste("MMPD_norm:", round(r3, 3))),
                        gridExtra::arrangeGrob(p4, top = paste("MMPD_norm:", round(r4, 3))),
                        ncol = 2, nrow=2)
