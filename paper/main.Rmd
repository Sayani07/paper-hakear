...
\noindent
**R-package:** The open-source R [@R-language] package `hakear` [@R-hakear] is available on Github (https://github.com/Sayani07/hakear) to implement ideas presented in this paper.
