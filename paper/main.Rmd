---
title: A new metric for automatic data visualization for distributional difference in time series
 ...
 * introduce a new distance measure for quantifying periodic interactions, which allows for identification
of patterns in the time series data;
 * device a framework for choosing a threshold, which results in detection of only significantly interesting
periodic patterns;
 * show that the proposed distance metric could be used to rank the periodic patterns based on
how well they capture the variation in the measured variable since they have been normalized for
relevant parameters.
